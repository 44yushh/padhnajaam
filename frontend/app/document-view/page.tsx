...
// 2. The main Page export now uses Suspense to avoid the Vercel Build Error
export default function DocumentViewPage() {
  return (
    <>
      <Navbar />
      <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading Document Viewer...</div>}>
        <DocumentContent />
      </Suspense>
      <Footer />
    </>
